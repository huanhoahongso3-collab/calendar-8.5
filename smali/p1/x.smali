...
.method public constructor <init>(Landroid/view/View;)V
    ...
    iput-object v0, p0, Lp1/x;->a:Ljava/util/HashSet;

    iput-object p1, p0, Lp1/x;->b:Landroid/view/View;
...
.method public static b(Landroid/view/View;Landroid/view/View;)Landroid/graphics/Rect;
    ...
    :cond_2
    new-instance p0, Lp1/w;

    const-string p1, "TouchTargetDelegate\'s delegateView must be child of anchorView"
...
# virtual methods
.method public final a(Landroid/view/View;Lp1/v;)V
    .locals 3

    :try_start_0
    iget-object v0, p0, Lp1/x;->b:Landroid/view/View;

    invoke-static {v0, p1}, Lp1/x;->b(Landroid/view/View;Landroid/view/View;)Landroid/graphics/Rect;
    ...
    invoke-direct {p2, p1, v0}, Lp1/u;-><init>(Landroid/view/View;Landroid/graphics/Rect;)V

    iget-object p0, p0, Lp1/x;->a:Ljava/util/HashSet;

    invoke-virtual {p0, p2}, Ljava/util/HashSet;->add(Ljava/lang/Object;)Z
    :try_end_0
    .catch Lp1/w; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final getTouchDelegateInfo()Landroid/view/accessibility/AccessibilityNodeInfo$TouchDelegateInfo;
    ...
    iget-object p0, p0, Lp1/x;->b:Landroid/view/View;
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v1, v0, Lp1/u;->a:Landroid/view/View;
    ...
    iget-object v0, v0, Lp1/u;->a:Landroid/view/View;
