...
.method public constructor <init>(LKl/l;)V
    ...
    .line 3
    sget-object p0, LKl/l;->d:Ljava/lang/String;
...
.method public static final l(ZZZZ)Ljava/lang/String;
    .locals 1
...
.method public static final m(Landroid/graphics/drawable/Drawable;Z)V
    .locals 1
...
.method public static n(Landroid/content/SharedPreferences;Landroidx/appcompat/app/o;Ljava/lang/String;)Ljava/lang/String;
    .locals 4
    ...
    sget v1, LFh/c;->ics_file_name_multiple_components:I
    ...
    invoke-static {v2, p1, v3, v1}, LXl/r;->d0(ZLjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v0, "share_file_name_postfix_vcs"
    ...
    const-string v0, "share_file_name_postfix_vts"
    ...
    :cond_2
    const-string v0, "share_file_name_postfix_ics"
    ...
    const-string v1, "_%03d."

    invoke-static {p0, v1, v0}, Ljava/lang/String;->format(Ljava/util/Locale;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;

    move-result-object p0

    invoke-static {p1, p0, p2}, Lt2/u;->n(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public static o(Ljava/lang/String;)LQj/e;
    .locals 1
    ...
    invoke-direct {v0, p0}, LQj/e;-><init>(Ljava/net/HttpURLConnection;)V
...
.method public a()V
    ...
    iget p0, p0, Lz6/e;->m:I

    packed-switch p0, :pswitch_data_0

    const-string p0, "020"

    const-string v0, "1224"
...
.method public d(Landroid/content/ContentResolver;)I
    ...
    filled-new-array {p1, v1, p0, p0}, [Ljava/lang/Object;
...
.method public e(LFg/h;Landroid/content/Context;)Landroid/content/ContentValues;
    ...
    iget-object v3, v1, LFg/m;->e0:Ljava/lang/String;
    ...
    iget-object v4, v1, LFg/h;->n:Ljava/lang/String;
    ...
    :goto_0
    iget-object v4, v1, LFg/m;->Q:Ljava/lang/CharSequence;
    ...
    iget-object v4, v1, LFg/m;->M:Ljava/lang/String;
    ...
    iget-object v7, v1, LFg/m;->M:Ljava/lang/String;

    nop

    :cond_4
    iget-boolean v4, v1, LFg/m;->U:Z
    ...
    invoke-virtual {v2, v7, v4}, Landroid/content/ContentValues;->put(Ljava/lang/String;Ljava/lang/Boolean;)V

    iget-boolean v4, v1, LFg/m;->V:Z
    ...
    const-string v8, "com.samsung.android.mobileservice"
    ...
    :goto_2
    invoke-virtual {v2, v11}, Landroid/content/ContentValues;->putNull(Ljava/lang/String;)V

    goto :goto_3

    :cond_6
    iget v4, v1, LFg/m;->O:I
    ...
    :cond_e
    :goto_4
    sget-object v4, LJg/j;->a:Ljava/lang/String;
    ...
    :cond_11
    iget-object v5, v1, LFg/m;->j0:Ljava/lang/String;
    ...
    :goto_5
    invoke-virtual {v2, v12, v5}, Landroid/content/ContentValues;->put(Ljava/lang/String;Ljava/lang/String;)V

    const/4 v5, 0x0

    invoke-virtual {v2, v13, v5}, Landroid/content/ContentValues;->put(Ljava/lang/String;Ljava/lang/Long;)V

    iget-object v7, v1, LFg/m;->g0:Ljava/lang/String;
    ...
    :cond_14
    iget-object v5, v1, LFg/m;->g0:Ljava/lang/String;
    ...
    iget-object v5, v1, LFg/m;->o0:Ljava/lang/String;
    ...
    iget-object v14, v1, LFg/m;->f0:Ljava/lang/String;
    ...
    sget-object v14, LJg/j;->a:Ljava/lang/String;
    ...
    iget-boolean v14, v1, LFg/h;->u:Z

    invoke-static {v5, v7, v14}, LJg/j;->a(LEh/a;Ljava/lang/String;Z)Ljava/lang/String;
    ...
    invoke-virtual {v5, v4}, Lnf/c;->g(Ljava/lang/String;)V

    iget v4, v5, Lnf/c;->b:I
    ...
    invoke-virtual {v4, v3}, LEh/a;->O(Ljava/lang/String;)V

    iget-wide v7, v1, LFg/h;->s:J

    invoke-virtual {v4, v7, v8}, LEh/a;->F(J)V
    ...
    iget-object v3, v1, LFg/m;->x0:Ljava/lang/String;
    ...
    invoke-direct {v3, v4, v7}, LI3/w;-><init>(IZ)V

    new-instance v4, Ljava/lang/ref/WeakReference;

    invoke-direct {v4, v0}, Ljava/lang/ref/WeakReference;-><init>(Ljava/lang/Object;)V

    iput-object v4, v3, LI3/w;->n:Ljava/lang/Object;

    iput-object v6, v3, LI3/w;->o:Ljava/lang/Object;

    new-instance v4, Ljava/util/HashMap;

    invoke-direct {v4}, Ljava/util/HashMap;-><init>()V

    iput-object v4, v3, LI3/w;->p:Ljava/lang/Object;

    iget-object v6, v1, LFg/m;->j1:Ljava/lang/String;

    invoke-static {v0, v6}, LJg/a;->a(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_23
    iget-object v6, v1, LFg/m;->k1:Ljava/lang/String;
    ...
    :cond_24
    invoke-virtual {v3}, LI3/w;->toString()Ljava/lang/String;

    move-result-object v0

    const-string v3, "secExtraCal"

    nop

    iget-boolean v0, v1, LFg/m;->k0:Z
    ...
    iget-object v0, v1, LFg/m;->P:Ljava/lang/CharSequence;
    ...
    :cond_27
    iget-boolean v0, v1, LFg/m;->w0:Z

    if-eqz v0, :cond_28

    iget-object v0, v1, LFg/m;->o0:Ljava/lang/String;
    ...
    :goto_f
    iget-object v0, v1, LFg/m;->x0:Ljava/lang/String;
    ...
    :cond_29
    iget-object v0, v1, LFg/m;->h1:Ljava/lang/String;

    iget-object v3, v1, LFg/m;->m1:LFg/n;

    if-eqz v3, :cond_2a

    invoke-static {v0, v3}, Lcom/google/android/gms/internal/auth/g;->Y(Ljava/lang/String;LFg/n;)Ljava/lang/String;
    ...
    :cond_30
    iget v0, v1, LFg/m;->S0:I

    invoke-static {v0}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v0

    const-string v3, "secExtra6"

    nop

    :cond_31
    iget-object v0, v1, LFg/m;->r1:Ljava/lang/String;
    ...
    invoke-direct {v1, v2, v3}, LRa/p;-><init>(Ljava/lang/Object;I)V
...
.method public f(Landroid/content/Context;Ljava/lang/String;Z)I
    ...
    :try_start_1
    sget-object v0, LE5/d;->c:Ljava/lang/Boolean;
    :try_end_1
    ...
    :try_start_4
    invoke-static {v5}, LE5/d;->d(Ljava/lang/ClassLoader;)V
    :try_end_4
    .catch LE5/a; {:try_start_4 .. :try_end_4} :catch_0
    ...
    :cond_1
    invoke-static {p1}, LE5/d;->e(Landroid/content/Context;)Z
    ...
    :cond_3
    :try_start_8
    invoke-static {p1, p2, p3, v1}, LE5/d;->c(Landroid/content/Context;Ljava/lang/String;ZZ)I

    move-result v6

    sget-object v7, LE5/d;->d:Ljava/lang/String;
    ...
    :cond_4
    invoke-static {}, LE5/f;->e0()Ljava/lang/ClassLoader;
    ...
    sget-object v8, LE5/d;->d:Ljava/lang/String;

    invoke-static {v8}, Lq5/k;->g(Ljava/lang/Object;)V
    ...
    :goto_0
    invoke-static {v7}, LE5/d;->d(Ljava/lang/ClassLoader;)V

    invoke-virtual {v0, v2, v7}, Ljava/lang/reflect/Field;->set(Ljava/lang/Object;Ljava/lang/Object;)V

    sput-object v5, LE5/d;->c:Ljava/lang/Boolean;
    :try_end_8
    .catch LE5/a; {:try_start_8 .. :try_end_8} :catch_1
    ...
    :goto_5
    sput-object v0, LE5/d;->c:Ljava/lang/Boolean;
    ...
    :try_start_11
    invoke-static {p1, p2, p3, v3}, LE5/d;->c(Landroid/content/Context;Ljava/lang/String;ZZ)I

    move-result v3
    :try_end_11
    .catch LE5/a; {:try_start_11 .. :try_end_11} :catch_3
    ...
    :cond_9
    invoke-static {p1}, LE5/d;->f(Landroid/content/Context;)LE5/i;
    ...
    :cond_a
    :try_start_13
    invoke-virtual {v4}, LI5/a;->n()Landroid/os/Parcel;

    move-result-object p0

    const/4 v0, 0x6

    invoke-virtual {v4, p0, v0}, LI5/a;->i(Landroid/os/Parcel;I)Landroid/os/Parcel;
    ...
    sget-object p0, LE5/d;->h:Ljava/lang/ThreadLocal;
    ...
    iget-object v0, v0, LE5/h;->a:Landroid/database/Cursor;
    ...
    invoke-direct {v5, p1}, LD5/b;-><init>(Ljava/lang/Object;)V

    sget-object v0, LE5/d;->i:LE5/g;
    ...
    invoke-virtual/range {v4 .. v9}, LE5/i;->s(LD5/b;Ljava/lang/String;ZJ)LD5/a;
    ...
    iget-object v0, p0, LE5/h;->a:Landroid/database/Cursor;

    if-nez v0, :cond_d

    iput-object p2, p0, LE5/h;->a:Landroid/database/Cursor;
    :try_end_14
    ...
    invoke-direct {p0, p1}, LD5/b;-><init>(Ljava/lang/Object;)V

    invoke-virtual {v4}, LI5/a;->n()Landroid/os/Parcel;

    move-result-object p2

    invoke-static {p2, p0}, LK5/a;->c(Landroid/os/Parcel;Landroid/os/IInterface;)V
    ...
    invoke-virtual {v4, p2, p0}, LI5/a;->i(Landroid/os/Parcel;I)Landroid/os/Parcel;
    ...
    invoke-direct {p2, p1}, LD5/b;-><init>(Ljava/lang/Object;)V

    invoke-virtual {v4}, LI5/a;->n()Landroid/os/Parcel;

    move-result-object p3

    invoke-static {p3, p2}, LK5/a;->c(Landroid/os/Parcel;Landroid/os/IInterface;)V

    invoke-virtual {p3, v6}, Landroid/os/Parcel;->writeString(Ljava/lang/String;)V

    invoke-virtual {p3, v7}, Landroid/os/Parcel;->writeInt(I)V

    invoke-virtual {v4, p3, p0}, LI5/a;->i(Landroid/os/Parcel;I)Landroid/os/Parcel;
...
.method public h()Ljava/lang/String;
    ...
    const-string v0, "GALAXY-CALENDAR-EVENT-"
...
.method public j(Landroid/content/Context;Ljava/lang/String;)I
    ...
    invoke-static {p1, p2}, LE5/d;->a(Landroid/content/Context;Ljava/lang/String;)I
...
.method public p(Landroid/content/Context;)LLe/a;
    .locals 2
