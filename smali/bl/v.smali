...
.method public final a(Lul/c;)Lbl/d;
    ...
    invoke-virtual {p0}, Lbl/v;->b()Ljava/lang/reflect/Member;
...
.method public final d([Ljava/lang/reflect/Type;[[Ljava/lang/annotation/Annotation;Z)Ljava/util/ArrayList;
    ...
    :try_start_2
    invoke-static {v3}, Lbl/c;->d(Ljava/lang/Class;)Ljava/lang/ClassLoader;
    ...
    invoke-direct {v6, v5, v3, v8, v7}, LTi/d;-><init>(Ljava/lang/Object;Ljava/lang/Object;ZI)V
    ...
    invoke-direct {v6, v4, v4, v5, v3}, LTi/d;-><init>(Ljava/lang/Object;Ljava/lang/Object;ZI)V

    :goto_0
    sput-object v6, Lbl/a;->b:LTi/d;
    :try_end_2
    ...
    :cond_1
    :goto_3
    iget-object v1, v3, LTi/d;->n:Ljava/lang/Object;
    ...
    new-instance v7, Lbl/y;

    invoke-direct {v7, v9}, Lbl/y;-><init>(Ljava/lang/Class;)V
    ...
    invoke-direct {v8, v7}, Lbl/D;-><init>(Ljava/lang/reflect/WildcardType;)V
    ...
    invoke-direct {v8, v7}, Lbl/p;-><init>(Ljava/lang/reflect/Type;)V
    ...
    invoke-direct {v8, v7}, Lbl/h;-><init>(Ljava/lang/reflect/Type;)V
    ...
    invoke-static {v8, v2}, Ltk/n;->c0(ILjava/util/List;)Ljava/lang/Object;
    ...
    invoke-virtual {p0}, Lbl/v;->c()Lul/e;
    ...
    invoke-direct {v9, v7, v11, v8, v10}, Lbl/C;-><init>(Lbl/A;[Ljava/lang/annotation/Annotation;Ljava/lang/String;Z)V
...
.method public final e()LVk/g0;
    ...
    sget-object p0, LVk/d0;->c:LVk/d0;
    ...
    sget-object p0, LZk/c;->c:LZk/c;

    return-object p0

    :cond_2
    sget-object p0, LZk/b;->c:LZk/b;

    return-object p0

    :cond_3
    sget-object p0, LZk/a;->c:LZk/a;
