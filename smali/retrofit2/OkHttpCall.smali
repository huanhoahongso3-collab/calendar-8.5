...
.field private final callFactory:Lpm/d;
...
# direct methods
.method public constructor <init>(Lretrofit2/RequestFactory;Ljava/lang/Object;[Ljava/lang/Object;Lpm/d;Lretrofit2/Converter;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p4, p0, Lretrofit2/OkHttpCall;->callFactory:Lpm/d;
...
.method private createRawCall()Lpm/e;
    .locals 3
    ...
    iget-object v0, p0, Lretrofit2/OkHttpCall;->callFactory:Lpm/d;
    ...
    invoke-virtual {v1, v2, p0}, Lretrofit2/RequestFactory;->create(Ljava/lang/Object;[Ljava/lang/Object;)Lpm/D;
...
.method private getRawCall()Lpm/e;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    iget-object v0, p0, Lretrofit2/OkHttpCall;->rawCall:Lpm/e;
    ...
    :cond_3
    :try_start_0
    invoke-direct {p0}, Lretrofit2/OkHttpCall;->createRawCall()Lpm/e;

    move-result-object v0

    iput-object v0, p0, Lretrofit2/OkHttpCall;->rawCall:Lpm/e;
    :try_end_0
...
.method public cancel()V
    ...
    iget-object p0, v0, Lpm/B;->n:Lsm/j;
...
.method public clone()Lretrofit2/OkHttpCall;
    ...
    iget-object v4, p0, Lretrofit2/OkHttpCall;->callFactory:Lpm/d;

    iget-object v5, p0, Lretrofit2/OkHttpCall;->responseConverter:Lretrofit2/Converter;

    invoke-direct/range {v0 .. v5}, Lretrofit2/OkHttpCall;-><init>(Lretrofit2/RequestFactory;Ljava/lang/Object;[Ljava/lang/Object;Lpm/d;Lretrofit2/Converter;)V
...
.method public enqueue(Lretrofit2/Callback;)V
    ...
    iput-object v2, p0, Lretrofit2/OkHttpCall;->rawCall:Lpm/e;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    iget-object v1, v1, Lpm/B;->n:Lsm/j;

    invoke-virtual {v1}, Lsm/j;->a()V
...
.method public execute()Lretrofit2/Response;
    ...
    invoke-direct {p0}, Lretrofit2/OkHttpCall;->getRawCall()Lpm/e;
    ...
    iget-object v2, v2, Lpm/B;->n:Lsm/j;

    invoke-virtual {v2}, Lsm/j;->a()V
    ...
    :try_start_1
    iget-boolean v2, v1, Lpm/B;->p:Z

    if-nez v2, :cond_1

    iput-boolean v0, v1, Lpm/B;->p:Z

    monitor-exit v1
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_2

    iget-object v0, v1, Lpm/B;->n:Lsm/j;

    iget-object v0, v0, Lsm/j;->e:Lsm/h;
    ...
    invoke-virtual {v2}, Lwm/j;->k()Ljava/lang/Object;

    move-result-object v2

    iput-object v2, v0, Lsm/j;->f:Ljava/lang/Object;
    ...
    :try_start_2
    iget-object v0, v1, Lpm/B;->m:Lpm/y;
    ...
    invoke-virtual {v1}, Lpm/B;->b()Lpm/I;

    move-result-object v0
    :try_end_4
    .catchall {:try_start_4 .. :try_end_4} :catchall_0

    iget-object v2, v1, Lpm/B;->m:Lpm/y;

    iget-object v2, v2, Lpm/y;->m:LI3/j;

    iget-object v3, v2, LI3/j;->p:Ljava/lang/Object;

    check-cast v3, Ljava/util/ArrayDeque;

    invoke-virtual {v2, v3, v1}, LI3/j;->B(Ljava/util/ArrayDeque;Ljava/lang/Object;)V

    invoke-virtual {p0, v0}, Lretrofit2/OkHttpCall;->parseResponse(Lpm/I;)Lretrofit2/Response;
    ...
    invoke-virtual {v0, v2, v1}, LI3/j;->B(Ljava/util/ArrayDeque;Ljava/lang/Object;)V
...
.method public isCanceled()Z
    ...
    iget-object v0, v0, Lpm/B;->n:Lsm/j;

    invoke-virtual {v0}, Lsm/j;->d()Z
...
.method public parseResponse(Lpm/I;)Lretrofit2/Response;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, v0}, Lretrofit2/OkHttpCall$ExceptionCatchingResponseBody;-><init>(Lpm/L;)V
    ...
    :goto_1
    :try_start_1
    invoke-static {v0}, Lretrofit2/Utils;->buffer(Lpm/L;)Lpm/L;

    move-result-object p0

    invoke-static {p0, p1}, Lretrofit2/Response;->error(Lpm/L;Lpm/I;)Lretrofit2/Response;
...
.method public declared-synchronized request()Lpm/D;
    .locals 3
    ...
    iget-object v0, v0, Lpm/B;->o:Lpm/D;
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized timeout()Lzm/x;
    .locals 3
