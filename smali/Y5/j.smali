...
.method public constructor <init>(Lcom/google/android/material/appbar/SeslImmersiveScrollBehavior;)V
    ...
    iput-object p1, p0, LY5/j;->a:Lcom/google/android/material/appbar/SeslImmersiveScrollBehavior;
...
.method public final onCancelled(Landroid/view/WindowInsetsAnimationController;)V
    ...
    iget-object p0, p0, LY5/j;->a:Lcom/google/android/material/appbar/SeslImmersiveScrollBehavior;
...
.method public final onFinished(Landroid/view/WindowInsetsAnimationController;)V
    ...
    iput-object p1, p0, Lcom/google/android/material/appbar/SeslImmersiveScrollBehavior;->h0:Landroid/view/WindowInsetsAnimationController;

    iput-object p1, p0, Lcom/google/android/material/appbar/SeslImmersiveScrollBehavior;->g0:Landroid/os/CancellationSignal;

    const/4 p1, 0x0

    iput-boolean p1, p0, Lcom/google/android/material/appbar/SeslImmersiveScrollBehavior;->l0:Z
...
.method public final onReady(Landroid/view/WindowInsetsAnimationController;I)V
    ...
    iget-object p2, p0, Lcom/google/android/material/appbar/SeslImmersiveScrollBehavior;->U:Landroid/view/View;

    if-eqz p2, :cond_2

    const/4 p2, 0x0

    iput-object p2, p0, Lcom/google/android/material/appbar/SeslImmersiveScrollBehavior;->g0:Landroid/os/CancellationSignal;

    iput-object p1, p0, Lcom/google/android/material/appbar/SeslImmersiveScrollBehavior;->h0:Landroid/view/WindowInsetsAnimationController;

    iget-object p1, p0, Lcom/google/android/material/appbar/SeslImmersiveScrollBehavior;->T:Landroid/content/Context;

    invoke-static {p1}, Lm9/M;->r(Landroid/content/Context;)Z
    ...
    invoke-static {v0}, Lm9/M;->p(Landroid/content/Context;)I
    ...
    :goto_0
    iget p1, p0, Lcom/google/android/material/appbar/SeslImmersiveScrollBehavior;->a0:I

    int-to-float p1, p1

    iget v1, p0, Lcom/google/android/material/appbar/SeslImmersiveScrollBehavior;->c0:I
