...
.field private final splitSupportStatus$delegate:Lsk/g;
...
.method public constructor <init>(Landroid/content/Context;Landroidx/window/embedding/EmbeddingInterfaceCompat;)V
    ...
    iput-object p1, p0, Landroidx/window/embedding/ExtensionEmbeddingBackend;->splitSupportStatus$delegate:Lsk/g;
...
.method public addSplitListenerForActivity(Landroid/app/Activity;Ljava/util/concurrent/Executor;Lo1/a;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p3, v2}, Lo1/a;->accept(Ljava/lang/Object;)V
    :try_end_1
    ...
    invoke-direct {v1, p1, p2, p3}, Landroidx/window/embedding/ExtensionEmbeddingBackend$SplitListenerWrapper;-><init>(Landroid/app/Activity;Ljava/util/concurrent/Executor;Lo1/a;)V
...
.method public getRules()Ljava/util/Set;
    ...
    invoke-virtual {p0}, Landroidx/window/embedding/ExtensionEmbeddingBackend$RuleTracker;->getSplitRules()LF/g;
...
.method public getSplitSupportStatus()Landroidx/window/embedding/SplitController$SplitSupportStatus;
    ...
    iget-object p0, p0, Landroidx/window/embedding/ExtensionEmbeddingBackend;->splitSupportStatus$delegate:Lsk/g;
...
.method public removeSplitListenerForActivity(Lo1/a;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v2}, Landroidx/window/embedding/ExtensionEmbeddingBackend$SplitListenerWrapper;->getCallback()Lo1/a;
...
.method public setSplitAttributesCalculator(LGk/j;)V
    ...
    invoke-interface {p0, p1}, Landroidx/window/embedding/EmbeddingInterfaceCompat;->setSplitAttributesCalculator(LGk/j;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
