...
.field private static final THUMB_TRACK_WIDTH_RATIO:F = 0.625f
...
.field private mEmojiCompatInitCallback:Landroidx/appcompat/widget/q1;
...
.field mPositionAnimator:Landroidx/appcompat/widget/r1;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-static {v4, p0}, Landroidx/appcompat/widget/s1;->a(Landroid/content/Context;Landroid/view/View;)V
    ...
    sget v4, Lh/c;->themeSwitchStyle:I
    ...
    :goto_0
    sget-object v7, Lh/m;->SwitchCompat:[I

    new-instance v4, LW4/e;

    invoke-virtual {p1, p2, v7, v10, v2}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[III)Landroid/content/res/TypedArray;

    move-result-object v9

    invoke-direct {v4, p1, v9}, LW4/e;-><init>(Landroid/content/Context;Landroid/content/res/TypedArray;)V
    ...
    sget p0, Lh/m;->SwitchCompat_android_thumb:I

    invoke-virtual {v4, p0}, LW4/e;->p(I)Landroid/graphics/drawable/Drawable;
    ...
    :cond_1
    sget p0, Lh/m;->SwitchCompat_track:I
    ...
    iget-object p0, v5, Landroidx/appcompat/widget/SwitchCompat;->mTrackDrawable:Landroid/graphics/drawable/Drawable;
    ...
    iput-object p1, v5, Landroidx/appcompat/widget/SwitchCompat;->mTrackOnDrawable:Landroid/graphics/drawable/Drawable;

    invoke-virtual {p0}, Landroid/graphics/drawable/Drawable$ConstantState;->newDrawable()Landroid/graphics/drawable/Drawable;

    move-result-object p0

    iput-object p0, v5, Landroidx/appcompat/widget/SwitchCompat;->mTrackOffDrawable:Landroid/graphics/drawable/Drawable;
    ...
    iput-object p0, v5, Landroidx/appcompat/widget/SwitchCompat;->mTrackOnDrawable:Landroid/graphics/drawable/Drawable;

    iput-object p0, v5, Landroidx/appcompat/widget/SwitchCompat;->mTrackOffDrawable:Landroid/graphics/drawable/Drawable;

    :goto_1
    iget-object p0, v5, Landroidx/appcompat/widget/SwitchCompat;->mTrackOnDrawable:Landroid/graphics/drawable/Drawable;
    ...
    iget-object p0, v5, Landroidx/appcompat/widget/SwitchCompat;->mTrackOffDrawable:Landroid/graphics/drawable/Drawable;
    ...
    :cond_3
    sget p0, Lh/m;->SwitchCompat_android_textOn:I

    invoke-virtual {v9, p0}, Landroid/content/res/TypedArray;->getText(I)Ljava/lang/CharSequence;

    move-result-object p0

    invoke-direct {v5, p0}, Landroidx/appcompat/widget/SwitchCompat;->setTextOnInternal(Ljava/lang/CharSequence;)V

    sget p0, Lh/m;->SwitchCompat_android_textOff:I
    ...
    sget p0, Lh/m;->SwitchCompat_showText:I

    invoke-virtual {v9, p0, v3}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result p0

    iput-boolean p0, v5, Landroidx/appcompat/widget/SwitchCompat;->mShowText:Z

    sget p0, Lh/m;->SwitchCompat_thumbTextPadding:I

    invoke-virtual {v9, p0, v2}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I

    move-result p0

    iput p0, v5, Landroidx/appcompat/widget/SwitchCompat;->mThumbTextPadding:I

    sget p0, Lh/m;->SwitchCompat_switchMinWidth:I
    ...
    sget p0, Lh/m;->SwitchCompat_switchPadding:I
    ...
    sget p0, Lh/m;->SwitchCompat_splitTrack:I

    invoke-virtual {v9, p0, v2}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result p0

    iput-boolean p0, v5, Landroidx/appcompat/widget/SwitchCompat;->mSplitTrack:Z

    sget p0, Lh/m;->SwitchCompat_thumbTint:I

    invoke-virtual {v4, p0}, LW4/e;->o(I)Landroid/content/res/ColorStateList;
    ...
    iput-boolean v3, v5, Landroidx/appcompat/widget/SwitchCompat;->mHasThumbTint:Z

    :cond_4
    sget p0, Lh/m;->SwitchCompat_thumbTintMode:I

    const/4 p1, -0x1

    invoke-virtual {v9, p0, p1}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result p0

    invoke-static {p0, v1}, Landroidx/appcompat/widget/e0;->b(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    iput-boolean v3, v5, Landroidx/appcompat/widget/SwitchCompat;->mHasThumbTintMode:Z
    ...
    :cond_7
    sget p0, Lh/m;->SwitchCompat_trackTint:I
    ...
    iput-boolean v3, v5, Landroidx/appcompat/widget/SwitchCompat;->mHasTrackTint:Z

    :cond_8
    sget p0, Lh/m;->SwitchCompat_trackTintMode:I
    ...
    iput-boolean v3, v5, Landroidx/appcompat/widget/SwitchCompat;->mHasTrackTintMode:Z
    ...
    :cond_b
    sget p0, Lh/m;->SwitchCompat_switchTextAppearance:I

    invoke-virtual {v9, p0, v2}, Landroid/content/res/TypedArray;->getResourceId(II)I
    ...
    invoke-direct {p0, v5}, Landroidx/appcompat/widget/S;-><init>(Landroid/widget/TextView;)V

    iput-object p0, v5, Landroidx/appcompat/widget/SwitchCompat;->mTextHelper:Landroidx/appcompat/widget/S;

    invoke-virtual {p0, v8, v0}, Landroidx/appcompat/widget/S;->g(Landroid/util/AttributeSet;I)V

    invoke-virtual {v4}, LW4/e;->J()V
    ...
    invoke-direct {v5}, Landroidx/appcompat/widget/SwitchCompat;->getEmojiTextViewHelper()Landroidx/appcompat/widget/y;

    move-result-object p0

    invoke-virtual {p0, v8, v0}, Landroidx/appcompat/widget/y;->b(Landroid/util/AttributeSet;I)V

    invoke-virtual {v5}, Landroid/view/View;->getResources()Landroid/content/res/Resources;

    move-result-object p0

    sget p1, Lh/f;->sesl_switch_width:I

    invoke-virtual {p0, p1}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result p0

    iput p0, v5, Landroidx/appcompat/widget/SwitchCompat;->mSwitchWidth:I

    invoke-virtual {v5}, Landroid/view/View;->getResources()Landroid/content/res/Resources;

    move-result-object p0

    sget p1, Lh/k;->sesl_switch_on:I

    invoke-virtual {p0, p1}, Landroid/content/res/Resources;->getString(I)Ljava/lang/String;

    move-result-object p0

    iput-object p0, v5, Landroidx/appcompat/widget/SwitchCompat;->mAccessibilityTextOn:Ljava/lang/CharSequence;

    invoke-virtual {v5}, Landroid/view/View;->getResources()Landroid/content/res/Resources;

    move-result-object p0

    sget p1, Lh/k;->sesl_switch_off:I

    invoke-virtual {p0, p1}, Landroid/content/res/Resources;->getString(I)Ljava/lang/String;

    move-result-object p0

    iput-object p0, v5, Landroidx/appcompat/widget/SwitchCompat;->mAccessibilityTextOff:Ljava/lang/CharSequence;
    ...
    invoke-direct {p0, v0, v1, p1, p2}, Landroid/view/animation/PathInterpolator;-><init>(FFFF)V

    iput-object p0, v5, Landroidx/appcompat/widget/SwitchCompat;->mInterpolator:Landroid/view/animation/PathInterpolator;
...
.method private getEmojiTextViewHelper()Landroidx/appcompat/widget/y;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->mAppCompatEmojiTextHelper:Landroidx/appcompat/widget/y;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->mAppCompatEmojiTextHelper:Landroidx/appcompat/widget/y;

    :cond_0
    iget-object p0, p0, Landroidx/appcompat/widget/SwitchCompat;->mAppCompatEmojiTextHelper:Landroidx/appcompat/widget/y;
...
.method private setTextOffInternal(Ljava/lang/CharSequence;)V
    ...
    iget-object v0, v0, Landroidx/appcompat/widget/y;->b:Lnm/i;

    iget-object v0, v0, Lnm/i;->n:Ljava/lang/Object;

    check-cast v0, LMk/H;

    invoke-virtual {v0, v1}, LMk/H;->w0(Landroid/text/method/TransformationMethod;)Landroid/text/method/TransformationMethod;
...
.method public final c()V
    ...
    sget v1, Lh/k;->abc_capital_off:I
    ...
    sget v3, LZ0/c;->tag_state_description:I
    ...
    invoke-virtual {v2, p0, v0}, LE1/c;->f(Landroid/view/View;Ljava/lang/Object;)V
...
.method public canHapticFeedback(Z)Z
    ...
    invoke-static {p0, p1}, LPe/a;->O(Landroid/view/View;Landroid/graphics/Rect;)Z
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v6}, Landroidx/appcompat/widget/e0;->a(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    :cond_0
    sget-object v6, Landroidx/appcompat/widget/e0;->a:Landroid/graphics/Rect;
...
.method public final e()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->mEmojiCompatInitCallback:Landroidx/appcompat/widget/q1;
    ...
    invoke-direct {v1, p0}, Landroidx/appcompat/widget/q1;-><init>(Landroidx/appcompat/widget/SwitchCompat;)V

    iput-object v1, p0, Landroidx/appcompat/widget/SwitchCompat;->mEmojiCompatInitCallback:Landroidx/appcompat/widget/q1;

    invoke-virtual {v0, v1}, LD1/k;->f(LD1/h;)V
...
.method public jumpDrawablesToCurrentState()V
    ...
    :cond_1
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->mPositionAnimator:Landroidx/appcompat/widget/r1;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->mPositionAnimator:Landroidx/appcompat/widget/r1;
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    sget v0, Lh/f;->sesl_switch_width:I
    ...
    sget v0, Lh/k;->sesl_switch_off:I
...
.method public onLayout(ZIIII)V
    ...
    invoke-static {p3}, Landroidx/appcompat/widget/e0;->a(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
...
.method public seslSetThumbStrokeColor(I)V
    ...
    sget v0, Lh/h;->sesl_switch_thumb_on:I
...
.method public seslSetTrackStrokeColor(I)V
    ...
    sget v0, Lh/h;->sesl_switch_track_on:I
...
.method public setChecked(Z)V
    ...
    iput-object v1, p0, Landroidx/appcompat/widget/SwitchCompat;->mPositionAnimator:Landroidx/appcompat/widget/r1;
    ...
    :cond_3
    invoke-direct {v0, p0, v1, v2}, Landroidx/appcompat/widget/r1;-><init>(Landroidx/appcompat/widget/SwitchCompat;FF)V
    ...
    invoke-direct {v1, p0, p1}, Landroidx/appcompat/widget/p1;-><init>(Landroidx/appcompat/widget/SwitchCompat;Z)V

    invoke-virtual {v0, v1}, Landroid/view/animation/Animation;->setAnimationListener(Landroid/view/animation/Animation$AnimationListener;)V

    iget-object p1, p0, Landroidx/appcompat/widget/SwitchCompat;->mPositionAnimator:Landroidx/appcompat/widget/r1;
...
.method public setSwitchTextAppearance(Landroid/content/Context;I)V
    ...
    sget v0, Lh/m;->TextAppearance_android_textColor:I
    ...
    invoke-static {v1, p1}, La1/b;->b(ILandroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    :goto_1
    sget p1, Lh/m;->TextAppearance_android_textSize:I
    ...
    sget v1, Lh/m;->TextAppearance_android_textStyle:I
    ...
    sget p1, Lh/m;->TextAppearance_textAllCaps:I
    ...
    iput-object v0, p1, Lq/a;->m:Ljava/util/Locale;
    ...
    :cond_6
    iput-object v3, p0, Landroidx/appcompat/widget/SwitchCompat;->mSwitchTransformationMethod:Landroid/text/method/TransformationMethod;
