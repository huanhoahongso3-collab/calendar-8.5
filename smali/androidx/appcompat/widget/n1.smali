...
.field public final w:Landroidx/appcompat/widget/SearchView;

.field public final x:Landroid/app/SearchableInfo;
...
.method public constructor <init>(Landroid/content/Context;Landroidx/appcompat/widget/SearchView;Landroid/app/SearchableInfo;Ljava/util/WeakHashMap;)V
    ...
    iput-boolean v1, p0, Ls1/a;->n:Z

    const/4 v2, 0x0

    iput-object v2, p0, Ls1/a;->o:Landroid/database/Cursor;

    const/4 v2, 0x0

    iput-boolean v2, p0, Ls1/a;->m:Z

    const/4 v3, -0x1

    iput v3, p0, Ls1/a;->p:I

    new-instance v4, LPa/p;

    invoke-direct {v4, p0}, LPa/p;-><init>(Landroidx/appcompat/widget/n1;)V

    iput-object v4, p0, Ls1/a;->q:LPa/p;

    new-instance v4, LD6/g;

    const/4 v5, 0x2

    invoke-direct {v4, p0, v5}, LD6/g;-><init>(Ljava/lang/Object;I)V

    iput-object v4, p0, Ls1/a;->r:LD6/g;

    iput v0, p0, Landroidx/appcompat/widget/n1;->u:I
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/n1;->v:Landroid/view/LayoutInflater;

    iput v1, p0, Landroidx/appcompat/widget/n1;->B:I

    iput v3, p0, Landroidx/appcompat/widget/n1;->D:I

    iput v3, p0, Landroidx/appcompat/widget/n1;->E:I

    iput v3, p0, Landroidx/appcompat/widget/n1;->F:I

    iput v3, p0, Landroidx/appcompat/widget/n1;->G:I

    iput v3, p0, Landroidx/appcompat/widget/n1;->H:I

    iput v3, p0, Landroidx/appcompat/widget/n1;->I:I

    const v0, -0xff5f32

    iput v0, p0, Landroidx/appcompat/widget/n1;->J:I

    iput-object p2, p0, Landroidx/appcompat/widget/n1;->w:Landroidx/appcompat/widget/SearchView;

    iput-object p3, p0, Landroidx/appcompat/widget/n1;->x:Landroid/app/SearchableInfo;
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/n1;->y:Landroid/content/Context;

    iput-object p4, p0, Landroidx/appcompat/widget/n1;->z:Ljava/util/WeakHashMap;
    ...
    iput p2, p0, Landroidx/appcompat/widget/n1;->J:I
...
.method public final a(Landroid/view/View;Landroid/database/Cursor;)V
    ...
    check-cast v3, Landroidx/appcompat/widget/m1;

    iget-object v0, v1, Landroidx/appcompat/widget/n1;->w:Landroidx/appcompat/widget/SearchView;
    ...
    iget v5, v1, Landroidx/appcompat/widget/n1;->I:I
    ...
    :goto_0
    iget-object v8, v3, Landroidx/appcompat/widget/m1;->a:Landroid/widget/TextView;

    iget-object v9, v3, Landroidx/appcompat/widget/m1;->e:Landroid/widget/ImageView;

    iget-object v10, v3, Landroidx/appcompat/widget/m1;->b:Landroid/widget/TextView;

    iget v11, v1, Landroidx/appcompat/widget/n1;->J:I

    const-string v13, "SuggestionsAdapter"

    if-eqz v8, :cond_6

    iget v15, v1, Landroidx/appcompat/widget/n1;->D:I

    invoke-static {v2, v15}, Landroidx/appcompat/widget/n1;->h(Landroid/database/Cursor;I)Ljava/lang/String;
    ...
    invoke-static {v14, v15, v6}, LDj/d;->a0(Landroid/text/TextPaint;Ljava/lang/String;[C)[C
    ...
    :cond_4
    invoke-static {v8, v15}, Landroidx/appcompat/widget/n1;->i(Landroid/widget/TextView;Ljava/lang/CharSequence;)V
    ...
    :goto_3
    iget-object v7, v1, Landroidx/appcompat/widget/n1;->y:Landroid/content/Context;

    const/4 v14, 0x1

    if-eqz v10, :cond_12

    iget v0, v1, Landroidx/appcompat/widget/n1;->F:I

    invoke-static {v2, v0}, Landroidx/appcompat/widget/n1;->h(Landroid/database/Cursor;I)Ljava/lang/String;

    move-result-object v0

    if-eqz v0, :cond_8

    iget-object v15, v1, Landroidx/appcompat/widget/n1;->C:Landroid/content/res/ColorStateList;
    ...
    sget v6, Lh/c;->textColorSearchUrl:I
    ...
    iput-object v6, v1, Landroidx/appcompat/widget/n1;->C:Landroid/content/res/ColorStateList;
    ...
    iget-object v12, v1, Landroidx/appcompat/widget/n1;->C:Landroid/content/res/ColorStateList;
    ...
    iget v0, v1, Landroidx/appcompat/widget/n1;->E:I
    ...
    invoke-static {v6, v0, v12}, LDj/d;->a0(Landroid/text/TextPaint;Ljava/lang/String;[C)[C
    ...
    invoke-static {v10, v12}, Landroidx/appcompat/widget/n1;->i(Landroid/widget/TextView;Ljava/lang/CharSequence;)V
    ...
    invoke-static {v10, v0}, Landroidx/appcompat/widget/n1;->i(Landroid/widget/TextView;Ljava/lang/CharSequence;)V
    ...
    :cond_11
    invoke-static {v10, v6}, Landroidx/appcompat/widget/n1;->i(Landroid/widget/TextView;Ljava/lang/CharSequence;)V

    :cond_12
    :goto_9
    iget-object v4, v3, Landroidx/appcompat/widget/m1;->c:Landroid/widget/ImageView;

    if-eqz v4, :cond_1c

    iget v0, v1, Landroidx/appcompat/widget/n1;->G:I
    ...
    invoke-virtual {v1, v0}, Landroidx/appcompat/widget/n1;->f(Ljava/lang/String;)Landroid/graphics/drawable/Drawable;
    ...
    :cond_14
    iget-object v0, v1, Landroidx/appcompat/widget/n1;->x:Landroid/app/SearchableInfo;
    ...
    iget-object v10, v1, Landroidx/appcompat/widget/n1;->z:Ljava/util/WeakHashMap;
    ...
    invoke-static {v14, v11, v12}, LU0/d;->m(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    :cond_1c
    :goto_f
    iget-object v0, v3, Landroidx/appcompat/widget/m1;->d:Landroid/widget/ImageView;

    if-eqz v0, :cond_1f

    iget v3, v1, Landroidx/appcompat/widget/n1;->H:I
    ...
    invoke-virtual {v1, v2}, Landroidx/appcompat/widget/n1;->f(Ljava/lang/String;)Landroid/graphics/drawable/Drawable;
    ...
    :goto_12
    iget v0, v1, Landroidx/appcompat/widget/n1;->B:I
...
.method public final b(Landroid/database/Cursor;)V
    ...
    iput p1, p0, Landroidx/appcompat/widget/n1;->I:I
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final c(Landroid/database/Cursor;)Ljava/lang/String;
    ...
    invoke-static {p1, v0}, Landroidx/appcompat/widget/n1;->h(Landroid/database/Cursor;I)Ljava/lang/String;
    ...
    :cond_1
    iget-object p0, p0, Landroidx/appcompat/widget/n1;->x:Landroid/app/SearchableInfo;
    ...
    invoke-static {p1, p0}, Landroidx/appcompat/widget/n1;->h(Landroid/database/Cursor;I)Ljava/lang/String;
...
.method public final d(Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/n1;->v:Landroid/view/LayoutInflater;
    ...
    invoke-direct {v0, p1}, Landroidx/appcompat/widget/m1;-><init>(Landroid/view/View;)V

    invoke-virtual {p1, v0}, Landroid/view/View;->setTag(Ljava/lang/Object;)V

    sget v0, Lh/h;->edit_query:I
    ...
    iget p0, p0, Landroidx/appcompat/widget/n1;->A:I
...
.method public final e(Landroid/net/Uri;)Landroid/graphics/drawable/Drawable;
    ...
    :try_start_0
    iget-object p0, p0, Landroidx/appcompat/widget/n1;->y:Landroid/content/Context;
...
.method public final f(Ljava/lang/String;)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/n1;->z:Ljava/util/WeakHashMap;

    const-string v1, "SuggestionsAdapter"

    iget-object v2, p0, Landroidx/appcompat/widget/n1;->y:Landroid/content/Context;
    ...
    :try_start_2
    invoke-virtual {p0, v3}, Landroidx/appcompat/widget/n1;->e(Landroid/net/Uri;)Landroid/graphics/drawable/Drawable;
...
.method public final getDropDownView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    iget p2, p0, Landroidx/appcompat/widget/n1;->u:I

    const/4 v0, 0x0

    iget-object p0, p0, Landroidx/appcompat/widget/n1;->v:Landroid/view/LayoutInflater;
    ...
    check-cast p2, Landroidx/appcompat/widget/m1;

    iget-object p2, p2, Landroidx/appcompat/widget/m1;->a:Landroid/widget/TextView;
...
.method public final getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    invoke-virtual {p0, p3}, Landroidx/appcompat/widget/n1;->d(Landroid/view/ViewGroup;)Landroid/view/View;
...
.method public final onClick(Landroid/view/View;)V
    ...
    iget-object p0, p0, Landroidx/appcompat/widget/n1;->w:Landroidx/appcompat/widget/SearchView;
