...
.field public final R:Lcom/samsung/android/app/calendar/commonlocationpicker/P;
...
.field public final V:Landroidx/appcompat/widget/ViewStubCompat;
...
.field public final w:Lcom/google/android/material/internal/c;
...
.method static constructor <clinit>()V
    ...
    sget v0, LW5/l;->Widget_Design_CollapsingToolbar:I

    sput v0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->i0:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget v3, LW5/a;->collapsingToolbarLayoutStyle:I

    sget v4, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->i0:I
    ...
    iput-object v0, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->S:Ljava/util/HashMap;
    ...
    sget-object v2, LW5/m;->CollapsingToolbarLayout:[I
    ...
    sget v1, LW5/m;->CollapsingToolbarLayout_titleEnabled:I

    invoke-virtual {p2, v1, v7}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result v1

    iput-boolean v1, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->y:Z

    sget v1, LW5/m;->CollapsingToolbarLayout_extendedTitleEnabled:I

    invoke-virtual {p2, v1, p1}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result v1

    iput-boolean v1, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->b0:Z
    ...
    iput-boolean v7, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->y:Z

    :cond_0
    sget v1, LW5/m;->CollapsingToolbarLayout_supportActionModeOverLay:I
    ...
    invoke-direct {v2, p0}, Lcom/google/android/material/internal/c;-><init>(Landroid/view/ViewGroup;)V

    iput-object v2, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->w:Lcom/google/android/material/internal/c;

    iget-boolean v3, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->y:Z

    if-eqz v3, :cond_2

    sget-object v3, LX5/a;->e:Landroid/view/animation/DecelerateInterpolator;

    iput-object v3, v2, Lcom/google/android/material/internal/c;->U:Landroid/animation/TimeInterpolator;

    invoke-virtual {v2, v7}, Lcom/google/android/material/internal/c;->i(Z)V

    iput-boolean v7, v2, Lcom/google/android/material/internal/c;->H:Z

    sget v3, LW5/m;->CollapsingToolbarLayout_expandedTitleGravity:I
    ...
    iget v4, v2, Lcom/google/android/material/internal/c;->h:I

    if-eq v4, v3, :cond_1

    iput v3, v2, Lcom/google/android/material/internal/c;->h:I

    invoke-virtual {v2, v7}, Lcom/google/android/material/internal/c;->i(Z)V

    :cond_1
    sget v3, LW5/m;->CollapsingToolbarLayout_collapsedTitleGravity:I
    ...
    sget v3, LW5/m;->CollapsingToolbarLayout_expandedTitleMargin:I

    invoke-virtual {p2, v3, v7}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I

    move-result v3

    iput v3, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->u:I
    ...
    invoke-direct {v3, v0}, Lj6/a;-><init>(Landroid/content/Context;)V

    iput-object v3, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->x:Lj6/a;

    sget v3, LW5/m;->CollapsingToolbarLayout_extendedTitleTextAppearance:I

    invoke-virtual {p2, v3, v7}, Landroid/content/res/TypedArray;->getResourceId(II)I

    move-result v3

    iput v3, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->e0:I

    sget v3, LW5/m;->CollapsingToolbarLayout_extendedSubtitleTextAppearance:I

    invoke-virtual {p2, v3, v7}, Landroid/content/res/TypedArray;->getResourceId(II)I

    move-result v3

    iput v3, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->d0:I

    sget v3, LW5/m;->CollapsingToolbarLayout_expandedTitleTextAppearance:I
    ...
    :cond_3
    sget v4, LW5/m;->CollapsingToolbarLayout_subtitle:I

    invoke-virtual {p2, v4}, Landroid/content/res/TypedArray;->getText(I)Ljava/lang/CharSequence;

    move-result-object v4

    iget-boolean v5, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->b0:Z
    ...
    :goto_0
    iput-boolean v5, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->c0:Z
    ...
    invoke-direct {v5, v8}, Lcom/samsung/android/app/calendar/commonlocationpicker/P;-><init>(Landroid/widget/FrameLayout;)V

    iput-object v5, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->R:Lcom/samsung/android/app/calendar/commonlocationpicker/P;
    ...
    iget-object v8, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->R:Lcom/samsung/android/app/calendar/commonlocationpicker/P;

    if-eqz v5, :cond_5

    iget-object v9, v8, Lcom/samsung/android/app/calendar/commonlocationpicker/P;->o:Ljava/lang/Object;

    check-cast v9, LY5/m;

    invoke-virtual {v9, v5}, LY5/m;->c(Landroid/view/View;)Landroid/view/View;

    iget-object v8, v8, Lcom/samsung/android/app/calendar/commonlocationpicker/P;->n:Ljava/lang/Object;
    ...
    :goto_1
    sget v8, LW5/e;->collapsing_appbar_title_layout_parent:I
    ...
    iput-object v5, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->U:Landroid/widget/LinearLayout;
    ...
    iget-object v8, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->U:Landroid/widget/LinearLayout;
    ...
    invoke-virtual {v8, v9, v10, v11, v5}, Landroid/view/View;->setPadding(IIII)V

    :cond_6
    sget v5, LW5/e;->collapsing_appbar_title_layout:I
    ...
    iput-object v5, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->T:Landroid/widget/LinearLayout;

    iget-boolean v5, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->b0:Z

    if-eqz v5, :cond_7

    sget v5, LW5/e;->collapsing_appbar_extended_title:I
    ...
    iget v8, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->e0:I

    invoke-virtual {v5, v0, v8}, Landroid/widget/TextView;->setTextAppearance(Landroid/content/Context;I)V

    invoke-virtual {v5, v7}, Landroid/view/View;->setVisibility(I)V

    iput-object v5, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->W:Landroid/widget/TextView;
    ...
    invoke-virtual {p0, v4}, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->c(Ljava/lang/CharSequence;)V
    ...
    sget v4, LW5/m;->CollapsingToolbarLayout_expandedTitleMarginStart:I
    ...
    :cond_9
    sget v4, LW5/m;->CollapsingToolbarLayout_expandedTitleMarginEnd:I
    ...
    iput v4, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->t:I

    :cond_a
    sget v4, LW5/m;->CollapsingToolbarLayout_expandedTitleMarginTop:I
    ...
    :cond_b
    sget v4, LW5/m;->CollapsingToolbarLayout_expandedTitleMarginBottom:I
    ...
    iput v4, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->u:I

    :cond_c
    sget v4, LW5/m;->CollapsingToolbarLayout_title:I
    ...
    iget-boolean v4, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->y:Z

    if-eqz v4, :cond_14

    sget v4, LW5/l;->TextAppearance_Design_CollapsingToolbar_Expanded:I

    invoke-virtual {v2, v4}, Lcom/google/android/material/internal/c;->n(I)V

    sget v4, Lh/l;->TextAppearance_AppCompat_Widget_ActionBar_Title:I

    invoke-virtual {v2, v4}, Lcom/google/android/material/internal/c;->k(I)V
    ...
    invoke-virtual {v2, v3}, Lcom/google/android/material/internal/c;->n(I)V

    :cond_d
    sget v3, LW5/m;->CollapsingToolbarLayout_collapsedTitleTextAppearance:I
    ...
    invoke-virtual {v2, v3}, Lcom/google/android/material/internal/c;->k(I)V

    :cond_e
    sget v3, LW5/m;->CollapsingToolbarLayout_titleTextEllipsize:I
    ...
    :cond_12
    sget v3, LW5/m;->CollapsingToolbarLayout_expandedTitleTextColor:I
    ...
    invoke-static {v0, p2, v3}, Ll2/f;->j(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;

    move-result-object v3

    iget-object v4, v2, Lcom/google/android/material/internal/c;->l:Landroid/content/res/ColorStateList;

    if-eq v4, v3, :cond_13

    iput-object v3, v2, Lcom/google/android/material/internal/c;->l:Landroid/content/res/ColorStateList;

    invoke-virtual {v2, v7}, Lcom/google/android/material/internal/c;->i(Z)V

    :cond_13
    sget v3, LW5/m;->CollapsingToolbarLayout_collapsedTitleTextColor:I
    ...
    iget-object v4, v2, Lcom/google/android/material/internal/c;->m:Landroid/content/res/ColorStateList;

    if-eq v4, v3, :cond_14

    iput-object v3, v2, Lcom/google/android/material/internal/c;->m:Landroid/content/res/ColorStateList;

    invoke-virtual {v2, v7}, Lcom/google/android/material/internal/c;->i(Z)V

    :cond_14
    sget v3, LW5/m;->CollapsingToolbarLayout_scrimVisibleHeightTrigger:I
    ...
    sget v3, LW5/m;->CollapsingToolbarLayout_maxLines:I
    ...
    iget v4, v2, Lcom/google/android/material/internal/c;->l0:I

    if-eq v3, v4, :cond_16

    iput v3, v2, Lcom/google/android/material/internal/c;->l0:I

    iget-object v3, v2, Lcom/google/android/material/internal/c;->I:Landroid/graphics/Bitmap;
    ...
    iput-object v3, v2, Lcom/google/android/material/internal/c;->I:Landroid/graphics/Bitmap;

    :cond_15
    invoke-virtual {v2, v7}, Lcom/google/android/material/internal/c;->i(Z)V

    :cond_16
    sget v3, LW5/m;->CollapsingToolbarLayout_titlePositionInterpolator:I
    ...
    iput-object v3, v2, Lcom/google/android/material/internal/c;->T:Landroid/animation/TimeInterpolator;

    invoke-virtual {v2, v7}, Lcom/google/android/material/internal/c;->i(Z)V

    :cond_17
    sget v2, LW5/m;->CollapsingToolbarLayout_scrimAnimationDuration:I
    ...
    iput-wide v2, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->F:J

    sget v2, LW5/a;->motionEasingStandardInterpolator:I

    sget-object v3, LX5/a;->c:Lz2/a;

    invoke-static {v0, v2, v3}, Ll6/a;->r(Landroid/content/Context;ILandroid/animation/TimeInterpolator;)Landroid/animation/TimeInterpolator;

    move-result-object v3

    iput-object v3, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->G:Landroid/animation/TimeInterpolator;

    sget-object v3, LX5/a;->d:Lz2/a;

    invoke-static {v0, v2, v3}, Ll6/a;->r(Landroid/content/Context;ILandroid/animation/TimeInterpolator;)Landroid/animation/TimeInterpolator;

    move-result-object v2

    iput-object v2, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->H:Landroid/animation/TimeInterpolator;

    sget v2, LW5/m;->CollapsingToolbarLayout_contentScrim:I
    ...
    sget v2, LW5/m;->CollapsingToolbarLayout_statusBarScrim:I
    ...
    sget v2, LW5/m;->CollapsingToolbarLayout_toolbarId:I
    ...
    sget v2, LW5/m;->CollapsingToolbarLayout_forceApplySystemWindowInsetTop:I

    invoke-virtual {p2, v2, v7}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result v2

    iput-boolean v2, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->O:Z

    sget v2, LW5/m;->CollapsingToolbarLayout_extraMultilineHeightEnabled:I

    invoke-virtual {p2, v2, v7}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result v2

    iput-boolean v2, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->Q:Z
    ...
    sget v1, LW5/h;->sesl_material_action_mode_view_stub:I

    invoke-virtual {v0, v1, p0, p1}, Landroid/view/LayoutInflater;->inflate(ILandroid/view/ViewGroup;Z)Landroid/view/View;

    sget p1, LW5/e;->action_mode_bar_stub:I
...
.method public static b(Landroid/view/View;)LY5/o;
    .locals 2

    sget v0, LW5/e;->view_offset_helper:I
    ...
    invoke-direct {v1, p0}, LY5/o;-><init>(Landroid/view/View;)V
...
.method private getDefaultContentScrimColorForTitleCollapseFadeMode()I
    ...
    sget v1, LW5/a;->colorSurfaceContainer:I
    ...
    sget v1, LW5/c;->design_appbar_elevation:I

    invoke-virtual {v0, v1}, Landroid/content/res/Resources;->getDimension(I)F

    move-result v0

    iget-object p0, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->x:Lj6/a;

    iget v1, p0, Lj6/a;->d:I

    invoke-virtual {p0, v0, v1}, Lj6/a;->a(FI)I
...
.method public final a()V
    ...
    iput-object v0, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->o:Landroid/view/ViewGroup;
    ...
    iput-object v1, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->o:Landroid/view/ViewGroup;
    ...
    :cond_2
    iput-object v1, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->p:Landroid/view/View;

    :cond_3
    iget-object v1, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->o:Landroid/view/ViewGroup;
...
.method public final addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
    ...
    :cond_1
    iget-object v1, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->a0:Landroid/widget/TextView;
...
.method public final c(Ljava/lang/CharSequence;)V
    ...
    sget v0, LW5/e;->collapsing_appbar_extended_subtitle:I
    ...
    iput-object v0, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->a0:Landroid/widget/TextView;
    ...
    sget v2, LW5/c;->sesl_appbar_extended_title_text_size_with_subtitle:I
...
.method public final d()V
    ...
    iget-boolean v1, v0, Lcom/google/android/material/appbar/AppBarLayout;->c0:Z
...
.method public final draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v1, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->w:Lcom/google/android/material/internal/c;
...
.method public final drawableStateChanged()V
    ...
    :goto_0
    iget-object v3, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->A:Landroid/graphics/drawable/Drawable;
    ...
    :cond_1
    iget-object v3, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->w:Lcom/google/android/material/internal/c;
...
.method public final e()V
    ...
    iget-object p0, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->q:Landroid/view/View;
...
.method public final g(IIIIZ)V
    ...
    :goto_0
    iput-boolean v0, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->z:Z
    ...
    :goto_2
    invoke-static {v3}, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->b(Landroid/view/View;)LY5/o;
    ...
    iget-object v3, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->q:Landroid/view/View;
    ...
    iput-boolean v2, v3, Lcom/google/android/material/internal/c;->Q:Z
...
.method public final generateLayoutParams(Landroid/util/AttributeSet;)Landroid/widget/FrameLayout$LayoutParams;
    ...
    .line 4
    iput v1, v0, LY5/d;->a:I

    const/high16 v2, 0x3f000000    # 0.5f

    .line 5
    iput v2, v0, LY5/d;->b:F

    .line 6
    sget-object v3, LW5/m;->CollapsingToolbarLayout_Layout:[I
    ...
    .line 7
    sget p1, LW5/m;->CollapsingToolbarLayout_Layout_layout_collapseMode:I
    ...
    iput p1, v0, LY5/d;->a:I

    .line 9
    sget p1, LW5/m;->CollapsingToolbarLayout_Layout_layout_collapseParallaxMultiplier:I
    ...
    .line 11
    iput p1, v0, LY5/d;->b:F

    .line 12
    sget p1, LW5/m;->CollapsingToolbarLayout_Layout_isCustomTitle:I

    invoke-virtual {p0, p1, v1}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result p1

    iput-boolean p1, v0, LY5/d;->c:Z
...
.method public getCollapsedTitleGravity()I
    ...
    iget-object p0, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->w:Lcom/google/android/material/internal/c;
...
.method public getContentScrim()Landroid/graphics/drawable/Drawable;
    ...
    iget-object p0, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->A:Landroid/graphics/drawable/Drawable;
...
.method public getScrimAnimationDuration()J
    ...
    iget-wide v0, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->F:J
...
.method public final h()V
    ...
    iget-object v0, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->w:Lcom/google/android/material/internal/c;
...
.method public final i()V
    ...
    iput v1, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->g0:F
    ...
    invoke-static {v1, v5, v3}, LU0/d;->t(Ljava/lang/StringBuilder;ZLjava/lang/String;)V

    iget-boolean v1, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->c0:Z
    ...
    :cond_1
    sget v1, LW5/c;->sesl_appbar_extended_title_text_size_with_subtitle:I
    ...
    sget v2, LW5/c;->sesl_appbar_extended_subtitle_text_size:I
    ...
    :cond_2
    :goto_0
    iget v1, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->g0:F
    ...
    :cond_5
    :goto_2
    iget-object v1, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->U:Landroid/widget/LinearLayout;
    ...
    :cond_7
    :goto_4
    iget-object v0, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->S:Ljava/util/HashMap;
    ...
    invoke-virtual {v1, v2}, LZ5/a;->updateResource(Landroid/content/Context;)V
...
.method public final onAttachedToWindow()V
    ...
    iget-object v1, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->J:LY5/e;

    if-nez v1, :cond_1

    new-instance v1, LY5/e;

    invoke-direct {v1, p0}, LY5/e;-><init>(Lcom/google/android/material/appbar/CollapsingToolbarLayout;)V

    iput-object v1, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->J:LY5/e;

    :cond_1
    iget-object v1, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->J:LY5/e;

    invoke-virtual {v0, v1}, Lcom/google/android/material/appbar/AppBarLayout;->b(LY5/c;)V
...
.method public final onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-static {p1}, LY5/p;->b(Landroid/content/Context;)F

    move-result p1

    iput p1, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->g0:F
...
.method public final onDetachedFromWindow()V
    ...
    iget-object v0, v0, Lcom/google/android/material/appbar/AppBarLayout;->t:Ljava/util/ArrayList;
...
.method public final onLayout(ZIIII)V
    ...
    iget-object p5, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->M:Lp1/f0;

    const/4 v0, 0x0

    if-eqz p5, :cond_1

    invoke-virtual {p5}, Lp1/f0;->d()I
    ...
    invoke-static {v2}, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->b(Landroid/view/View;)LY5/o;

    move-result-object v2

    iget-object v3, v2, LY5/o;->a:Landroid/view/View;

    invoke-virtual {v3}, Landroid/view/View;->getTop()I

    move-result v4

    iput v4, v2, LY5/o;->b:I

    invoke-virtual {v3}, Landroid/view/View;->getLeft()I

    move-result v3

    iput v3, v2, LY5/o;->c:I
    ...
    invoke-static {p2}, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->b(Landroid/view/View;)LY5/o;

    move-result-object p2

    invoke-virtual {p2}, LY5/o;->a()V
...
.method public final onMeasure(II)V
    ...
    iget-boolean p2, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->y:Z

    if-eqz p2, :cond_3

    iget-object p2, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->w:Lcom/google/android/material/internal/c;
    ...
    iget p0, p2, Lcom/google/android/material/internal/c;->n:I

    if-le p0, v2, :cond_4

    iget-object v0, p2, Lcom/google/android/material/internal/c;->S:Landroid/text/TextPaint;
    ...
    iput p0, v3, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->P:I

    invoke-virtual {v3}, Landroid/view/View;->getMeasuredHeight()I

    move-result p0

    iget p2, v3, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->P:I
    ...
    :cond_4
    :goto_1
    iget-object p0, v3, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->o:Landroid/view/ViewGroup;

    if-eqz p0, :cond_9

    iget-object p1, v3, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->p:Landroid/view/View;
...
.method public setScrimAnimationDuration(J)V
    ...
    iput-wide p1, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->F:J
...
.method public setScrimsShown(Z)V
    ...
    :goto_0
    iget-boolean v2, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->D:Z
    ...
    iget-object v0, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->E:Landroid/animation/ValueAnimator;
    ...
    iput-object v0, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->E:Landroid/animation/ValueAnimator;
    ...
    iget-wide v2, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->F:J
...
.method public setStaticLayoutBuilderConfigurer(LY5/f;)V
    .locals 0
...
.method public setTitleCollapseMode(I)V
    ...
    :goto_0
    iget-object v2, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->w:Lcom/google/android/material/internal/c;
...
.method public setTitleEnabled(Z)V
    ...
    iget-boolean p1, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->y:Z
