...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget v0, LW5/a;->materialClockStyle:I
    ...
    sget-object v2, LW5/m;->ClockFaceView:[I

    sget v3, LW5/l;->Widget_MaterialComponents_TimePicker_Clock:I
    ...
    sget v2, LW5/m;->ClockFaceView_clockNumberTextColor:I

    invoke-static {p1, p2, v2}, Ll2/f;->j(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;

    move-result-object v2

    iput-object v2, p0, Lcom/google/android/material/timepicker/ClockFaceView;->D:Landroid/content/res/ColorStateList;

    invoke-static {p1}, Landroid/view/LayoutInflater;->from(Landroid/content/Context;)Landroid/view/LayoutInflater;

    move-result-object v3

    sget v4, LW5/h;->material_clockface_view:I

    const/4 v5, 0x1

    invoke-virtual {v3, v4, p0, v5}, Landroid/view/LayoutInflater;->inflate(ILandroid/view/ViewGroup;Z)Landroid/view/View;

    sget v3, LW5/e;->material_clock_hand:I
    ...
    sget v4, LW5/c;->material_clock_hand_padding:I

    invoke-virtual {v0, v4}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v4

    iput v4, p0, Lcom/google/android/material/timepicker/ClockFaceView;->x:I
    ...
    iput-object v2, p0, Lcom/google/android/material/timepicker/ClockFaceView;->v:[I

    iget-object v2, v3, Lcom/google/android/material/timepicker/ClockHandView;->o:Ljava/util/ArrayList;

    invoke-virtual {v2, p0}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    sget v2, LW5/b;->material_timepicker_clockface:I
    ...
    invoke-static {v2, v4, v3}, Lc1/j;->a(ILandroid/content/res/Resources$Theme;Landroid/content/res/Resources;)Landroid/content/res/ColorStateList;
    ...
    sget v3, LW5/m;->ClockFaceView_clockFaceBackgroundColor:I

    invoke-static {p1, p2, v3}, Ll2/f;->j(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
    ...
    iput-object p1, p0, Lcom/google/android/material/timepicker/ClockFaceView;->B:[Ljava/lang/String;
    ...
    :goto_1
    iget-object v6, p0, Lcom/google/android/material/timepicker/ClockFaceView;->B:[Ljava/lang/String;
    ...
    iget-object v7, p0, Lcom/google/android/material/timepicker/ClockFaceView;->B:[Ljava/lang/String;
    ...
    sget v6, LW5/h;->material_clockface_textview:I
    ...
    sget v7, LW5/e;->material_value_index:I
    ...
    sget v8, LW5/e;->material_clock_level:I
    ...
    :cond_3
    iget-object v7, p0, Lcom/google/android/material/timepicker/ClockFaceView;->u:Lcom/google/android/material/timepicker/c;

    invoke-static {v6, v7}, Lp1/L;->i(Landroid/view/View;Lp1/b;)V

    iget-object v7, p0, Lcom/google/android/material/timepicker/ClockFaceView;->D:Landroid/content/res/ColorStateList;
    ...
    iput v5, p1, Lcom/google/android/material/timepicker/ClockHandView;->y:I

    :cond_5
    iput-boolean v4, p1, Lcom/google/android/material/timepicker/ClockHandView;->n:Z

    invoke-virtual {p1}, Landroid/view/View;->invalidate()V

    sget p1, LW5/c;->material_time_picker_minimum_screen_height:I
    ...
    sget p1, LW5/c;->material_time_picker_minimum_screen_width:I
    ...
    sget p1, LW5/c;->material_clock_size:I
...
.method public final c()V
    ...
    :cond_0
    sget v5, LW5/e;->material_clock_level:I
    ...
    iget v3, p0, Lcom/google/android/material/timepicker/e;->n:I
    ...
    sget v8, LW5/e;->circle_center:I

    invoke-virtual {v0, v7}, Landroidx/constraintlayout/widget/q;->k(I)Landroidx/constraintlayout/widget/l;

    move-result-object v7

    iget-object v7, v7, Landroidx/constraintlayout/widget/l;->d:Landroidx/constraintlayout/widget/m;

    iput v8, v7, Landroidx/constraintlayout/widget/m;->z:I

    iput v3, v7, Landroidx/constraintlayout/widget/m;->A:I

    iput v6, v7, Landroidx/constraintlayout/widget/m;->B:F
...
.method public final onInitializeAccessibilityNodeInfo(Landroid/view/accessibility/AccessibilityNodeInfo;)V
    ...
    iget-object p0, p0, Lcom/google/android/material/timepicker/ClockFaceView;->B:[Ljava/lang/String;
...
.method public final onMeasure(II)V
    ...
    iget v0, p0, Lcom/google/android/material/timepicker/ClockFaceView;->A:I

    int-to-float v0, v0

    iget v1, p0, Lcom/google/android/material/timepicker/ClockFaceView;->y:I

    int-to-float v1, v1

    div-float/2addr v1, p2

    iget p2, p0, Lcom/google/android/material/timepicker/ClockFaceView;->z:I
