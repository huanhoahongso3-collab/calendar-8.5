...
.method public static expand(Ljava/lang/String;Ljava/lang/Object;Z)Ljava/lang/String;
    ...
    invoke-direct {v6, v8, v7}, LG6/c;-><init>(CI)V

    .line 23
    new-instance v7, LG6/i;

    new-instance v8, Lnm/i;

    const/4 v9, 0x3

    invoke-direct {v8, v6, v9}, Lnm/i;-><init>(Ljava/lang/Object;I)V

    invoke-direct {v7, v8}, LG6/i;-><init>(Lnm/i;)V
    ...
    invoke-direct {v6, v8, v7, v3}, LG6/g;-><init>(Lnm/i;LG6/i;Ljava/lang/CharSequence;)V
    ...
    .line 27
    :goto_1
    invoke-virtual {v6}, LG6/g;->hasNext()Z
    ...
    .line 28
    invoke-virtual {v6}, LG6/g;->next()Ljava/lang/Object;
