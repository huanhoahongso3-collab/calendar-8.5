...
# static fields
.field public static final q:Lpl/p;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lpl/p;->r:Lpl/a;

    new-instance v0, Lpl/p;

    invoke-direct {v0}, Lpl/p;-><init>()V

    sput-object v0, Lpl/p;->q:Lpl/p;

    sget-object v1, Ljava/util/Collections;->EMPTY_LIST:Ljava/util/List;

    iput-object v1, v0, Lpl/p;->n:Ljava/util/List;
...
.method public constructor <init>()V
    ...
    .line 2
    iput-byte v0, p0, Lpl/p;->o:B

    .line 3
    iput v0, p0, Lpl/p;->p:I

    .line 4
    sget-object v0, Lvl/d;->m:Lvl/t;

    iput-object v0, p0, Lpl/p;->m:Lvl/d;
...
.method public constructor <init>(Lpl/o;)V
    ...
    .line 9
    iput-object p1, p0, Lpl/p;->m:Lvl/d;
...
.method public constructor <init>(Lvl/e;Lvl/g;)V
    ...
    iput-object v0, p0, Lpl/p;->n:Ljava/util/List;
    ...
    iput-object v5, p0, Lpl/p;->n:Ljava/util/List;

    move v4, v1

    .line 19
    :cond_3
    iget-object v5, p0, Lpl/p;->n:Ljava/util/List;

    sget-object v6, Lpl/t;->v:Lpl/a;
    ...
    .line 26
    iget-object p2, p0, Lpl/p;->n:Ljava/util/List;

    invoke-static {p2}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p2

    iput-object p2, p0, Lpl/p;->n:Ljava/util/List;
    ...
    iput-object p2, p0, Lpl/p;->m:Lvl/d;
    ...
    .line 31
    iget-object p1, p0, Lpl/p;->n:Ljava/util/List;

    invoke-static {p1}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p1

    iput-object p1, p0, Lpl/p;->n:Ljava/util/List;
...
.method public final a()I
    ...
    :goto_0
    iget-object v2, p0, Lpl/p;->n:Ljava/util/List;
    ...
    :cond_1
    iget-object v0, p0, Lpl/p;->m:Lvl/d;
...
.method public final d(LBe/d;)V
    ...
    invoke-virtual {p0}, Lpl/p;->a()I

    const/4 v0, 0x0

    :goto_0
    iget-object v1, p0, Lpl/p;->n:Ljava/util/List;
    ...
    :cond_0
    iget-object p0, p0, Lpl/p;->m:Lvl/d;
...
.method public final isInitialized()Z
    ...
    :goto_0
    iget-object v3, p0, Lpl/p;->n:Ljava/util/List;
