...
.field public final n:Landroid/app/job/JobScheduler;

.field public final o:LD3/c;

.field public final p:Landroidx/work/impl/WorkDatabase;

.field public final q:Lz3/b;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, LD3/d;->r:Ljava/lang/String;

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Landroidx/work/impl/WorkDatabase;Lz3/b;)V
    .locals 4

    invoke-static {p1}, LD3/a;->b(Landroid/content/Context;)Landroid/app/job/JobScheduler;

    move-result-object v0

    new-instance v1, LD3/c;

    iget-object v2, p3, Lz3/b;->d:Lz3/j;

    iget-boolean v3, p3, Lz3/b;->l:Z

    invoke-direct {v1, p1, v2, v3}, LD3/c;-><init>(Landroid/content/Context;Lz3/j;Z)V

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, LD3/d;->m:Landroid/content/Context;

    iput-object v0, p0, LD3/d;->n:Landroid/app/job/JobScheduler;

    iput-object v1, p0, LD3/d;->o:LD3/c;

    iput-object p2, p0, LD3/d;->p:Landroidx/work/impl/WorkDatabase;

    iput-object p3, p0, LD3/d;->q:Lz3/b;
...
.method public static a(Landroid/app/job/JobScheduler;I)V
    ...
    sget-object v1, LD3/d;->r:Ljava/lang/String;

    invoke-virtual {v0, v1, p1, p0}, Lz3/t;->c(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public static e(Landroid/content/Context;Landroid/app/job/JobScheduler;)Ljava/util/ArrayList;
    ...
    invoke-static {p1}, LD3/a;->a(Landroid/app/job/JobScheduler;)Ljava/util/List;
...
.method public static f(Landroid/app/job/JobInfo;)LI3/k;
    .locals 3
    ...
    invoke-direct {v2, p0, v1}, LI3/k;-><init>(Ljava/lang/String;I)V
    :try_end_0
...
.method public final c(Ljava/lang/String;)V
    ...
    iget-object v0, p0, LD3/d;->m:Landroid/content/Context;

    iget-object v1, p0, LD3/d;->n:Landroid/app/job/JobScheduler;

    invoke-static {v0, v1}, LD3/d;->e(Landroid/content/Context;Landroid/app/job/JobScheduler;)Ljava/util/ArrayList;
    ...
    invoke-static {v3}, LD3/d;->f(Landroid/app/job/JobInfo;)LI3/k;
    ...
    invoke-static {v1, v2}, LD3/d;->a(Landroid/app/job/JobScheduler;I)V

    goto :goto_2

    :cond_3
    iget-object p0, p0, LD3/d;->p:Landroidx/work/impl/WorkDatabase;

    invoke-virtual {p0}, Landroidx/work/impl/WorkDatabase;->A()LI3/j;
...
.method public final varargs d([LI3/r;)V
    ...
    iget-object v0, p0, LD3/d;->q:Lz3/b;

    new-instance v1, LI3/g;

    iget-object v2, p0, LD3/d;->p:Landroidx/work/impl/WorkDatabase;

    invoke-direct {v1, v2}, LI3/g;-><init>(Landroidx/work/impl/WorkDatabase;)V
    ...
    :try_start_0
    invoke-virtual {v2}, Landroidx/work/impl/WorkDatabase;->D()LI3/u;

    move-result-object v6

    iget-object v7, v5, LI3/r;->a:Ljava/lang/String;

    invoke-virtual {v6, v7}, LI3/u;->j(Ljava/lang/String;)LI3/r;
    ...
    invoke-virtual {v5, v9, v6}, Lz3/t;->g(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_0
    :try_start_2
    iget-object v6, v6, LI3/r;->b:Lz3/C;

    sget-object v10, Lz3/C;->m:Lz3/C;
    ...
    invoke-virtual {v2}, Landroidx/work/impl/WorkDatabase;->A()LI3/j;

    move-result-object v7

    invoke-virtual {v7, v6}, LI3/j;->W(LI3/k;)LI3/h;

    move-result-object v7

    if-eqz v7, :cond_2

    iget v8, v7, LI3/h;->c:I
    ...
    iget v8, v0, Lz3/b;->i:I

    iget-object v9, v1, LI3/g;->n:Ljava/lang/Object;
    ...
    invoke-direct {v10, v1, v8, v11}, LJ3/f;-><init>(Ljava/lang/Object;II)V

    invoke-virtual {v9, v10}, Lb3/s;->t(Ljava/util/concurrent/Callable;)Ljava/lang/Object;
    ...
    iget-object v9, v6, LI3/k;->a:Ljava/lang/String;

    iget v6, v6, LI3/k;->b:I

    invoke-direct {v7, v9, v6, v8}, LI3/h;-><init>(Ljava/lang/String;II)V

    invoke-virtual {v2}, Landroidx/work/impl/WorkDatabase;->A()LI3/j;

    move-result-object v6

    invoke-virtual {v6, v7}, LI3/j;->d0(LI3/h;)V

    :cond_3
    invoke-virtual {p0, v5, v8}, LD3/d;->g(LI3/r;I)V
...
.method public final g(LI3/r;I)V
    .locals 12

    iget-object v0, p0, LD3/d;->o:LD3/c;

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object v1, p1, LI3/r;->j:Lz3/e;

    new-instance v2, Landroid/os/PersistableBundle;

    invoke-direct {v2}, Landroid/os/PersistableBundle;-><init>()V

    iget-object v3, p1, LI3/r;->a:Ljava/lang/String;
    ...
    invoke-virtual {v1}, Lz3/e;->a()Landroid/net/NetworkRequest;
    ...
    sget-object v10, LD3/c;->d:Ljava/lang/String;

    invoke-static {v4}, Lt2/u;->q(I)Ljava/lang/String;
    ...
    invoke-virtual {v9, v10, v4}, Lz3/t;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_9
    :goto_3
    invoke-virtual {v1}, Lz3/e;->b()Z

    move-result v0

    if-eqz v0, :cond_b

    iget-object v0, v1, Lz3/e;->i:Ljava/util/Set;
    ...
    iget-boolean v5, v4, Lz3/d;->b:Z

    new-instance v9, Landroid/app/job/JobInfo$TriggerContentUri;

    iget-object v4, v4, Lz3/d;->a:Landroid/net/Uri;
    ...
    iget-object v0, p1, LI3/r;->x:Ljava/lang/String;

    if-eqz v0, :cond_f

    invoke-static {v2, v0}, LD3/b;->a(Landroid/app/job/JobInfo$Builder;Ljava/lang/String;)V
    ...
    sget-object v4, LD3/d;->r:Ljava/lang/String;

    invoke-virtual {v1, v4, v2}, Lz3/t;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v4, v1}, Lz3/t;->g(Ljava/lang/String;Ljava/lang/String;)V

    iget-boolean v0, p1, LI3/r;->q:Z

    if-eqz v0, :cond_10

    iget v0, p1, LI3/r;->r:I

    if-ne v0, v8, :cond_10

    iput-boolean v7, p1, LI3/r;->q:Z
    ...
    invoke-virtual {v1, v4, v0}, Lz3/t;->a(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p0, p1, p2}, LD3/d;->g(LI3/r;I)V
    :try_end_0
    ...
    invoke-virtual {p2, v4, p1, p0}, Lz3/t;->c(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {p2}, LI3/u;->h()Ljava/util/ArrayList;
    ...
    invoke-static {v1}, LD3/a;->a(Landroid/app/job/JobScheduler;)Ljava/util/List;
    ...
    invoke-static {v3, v5}, Lt2/u;->c(ILjava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0, v5}, LD3/d;->e(Landroid/content/Context;Landroid/app/job/JobScheduler;)Ljava/util/ArrayList;
    ...
    invoke-static {v7, v0}, Lt2/u;->c(ILjava/lang/String;)Ljava/lang/String;
    ...
    const-string v3, "JobScheduler 150 job limit exceeded.\nIn JobScheduler there are "

    invoke-static {p2, v3, v0, v1, v2}, Lt2/u;->h(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object p2

    iget p0, p0, Lz3/b;->k:I

    const/16 v0, 0x2e

    invoke-static {p2, p0, v0}, Lcom/samsung/android/sdk/handwriting/a;->o(Ljava/lang/StringBuilder;IC)Ljava/lang/String;
    ...
    invoke-virtual {p2, v4, p0}, Lz3/t;->b(Ljava/lang/String;Ljava/lang/String;)V
