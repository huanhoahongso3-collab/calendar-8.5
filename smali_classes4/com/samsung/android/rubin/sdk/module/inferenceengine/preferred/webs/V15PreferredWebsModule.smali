.class public final Lcom/samsung/android/rubin/sdk/module/inferenceengine/preferred/webs/V15PreferredWebsModule;
.super Ljava/lang/Object;
.source "SourceFile"

# interfaces
.implements Lcom/samsung/android/rubin/sdk/module/inferenceengine/preferred/webs/PreferredWebsModule;
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "Lcom/samsung/android/rubin/sdk/module/inferenceengine/preferred/webs/V15PreferredWebsModule;",
...
.method public constructor <init>()V
    ...
    sget-object v1, Lcom/samsung/android/rubin/sdk/module/inferenceengine/preferred/webs/V15PreferredWebsModule$special$$inlined$inject$1;->INSTANCE:Lcom/samsung/android/rubin/sdk/module/inferenceengine/preferred/webs/V15PreferredWebsModule$special$$inlined$inject$1;

    invoke-static {v0, v1}, Lm2/s;->s(Lsk/h;Lkotlin/jvm/functions/Function0;)Lsk/g;

    move-result-object v0

    iput-object v0, p0, Lcom/samsung/android/rubin/sdk/module/inferenceengine/preferred/webs/V15PreferredWebsModule;->ctx$delegate:Lsk/g;

    sget-object v1, Lbi/H;->a:Landroid/net/Uri;

    sget-object v2, Lbi/H;->b:Landroid/net/Uri;

    sget-object v3, Lbi/H;->c:Landroid/net/Uri;

    sget-object v4, Lbi/H;->d:Landroid/net/Uri;

    sget-object v5, Lbi/H;->e:Landroid/net/Uri;

    sget-object v6, Lbi/H;->f:Landroid/net/Uri;

    sget-object v7, Lbi/H;->g:Landroid/net/Uri;

    sget-object v8, Lbi/H;->h:Landroid/net/Uri;

    sget-object v9, Lbi/H;->i:Landroid/net/Uri;

    filled-new-array/range {v1 .. v9}, [Landroid/net/Uri;
    ...
    iput-object v0, p0, Lcom/samsung/android/rubin/sdk/module/inferenceengine/preferred/webs/V15PreferredWebsModule;->uris:Ljava/util/List;
...
.method private final getCtx()Lkotlin/jvm/functions/Function0;
    ...
    iget-object p0, p0, Lcom/samsung/android/rubin/sdk/module/inferenceengine/preferred/webs/V15PreferredWebsModule;->ctx$delegate:Lsk/g;
...
# virtual methods
.method public getPreferredDomains()Lcom/samsung/android/rubin/sdk/common/result/ApiResult;
    .locals 16
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    sget-object v3, Lbi/H;->f:Landroid/net/Uri;

    const-string v2, "DOMAINS_URI"
    ...
    const-class v5, Lcom/samsung/android/rubin/sdk/module/inferenceengine/preferred/model/PreferredWeb;
...
.method public getPreferredDomainsForAllConditions()Lcom/samsung/android/rubin/sdk/common/result/ApiResult;
    .locals 16
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    sget-object v3, Lbi/H;->g:Landroid/net/Uri;

    const-string v2, "DOMAINS_ALL_CONDITIONS_CONTENT_URI"
...
.method public getPreferredDomainsForTimeRange(J)Lcom/samsung/android/rubin/sdk/common/result/ApiResult;
    .locals 16
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(J)",
    ...
    sget-object v2, Lbi/H;->h:Landroid/net/Uri;

    const-string/jumbo v3, "withAppendedPath(\n      \u2026.toString()\n            )"

    move-wide/from16 v4, p1

    invoke-static {v4, v5, v2, v3}, Lcom/samsung/android/sdk/handwriting/a;->j(JLandroid/net/Uri;Ljava/lang/String;)Landroid/net/Uri;
...
.method public getPreferredDomainsForTpoContext(Lcom/samsung/android/rubin/sdk/common/TpoContext;)Lcom/samsung/android/rubin/sdk/common/result/ApiResult;
    .locals 16
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    sget-object v3, Lbi/H;->i:Landroid/net/Uri;
...
.method public getPreferredWebs()Lcom/samsung/android/rubin/sdk/common/result/ApiResult;
    .locals 16
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .line 2
    sget-object v3, Lbi/H;->a:Landroid/net/Uri;
...
.method public getPreferredWebs(J)Lcom/samsung/android/rubin/sdk/common/result/ApiResult;
    .locals 16
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(J)",
    ...
    .line 39
    sget-object v2, Lbi/H;->a:Landroid/net/Uri;
...
.method public getPreferredWebsForAllConditions()Lcom/samsung/android/rubin/sdk/common/result/ApiResult;
    .locals 16
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    sget-object v3, Lbi/H;->b:Landroid/net/Uri;
...
.method public getPreferredWebsForMostVisit()Lcom/samsung/android/rubin/sdk/common/result/ApiResult;
    .locals 16
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    sget-object v3, Lbi/H;->e:Landroid/net/Uri;

    const-string v2, "MOST_VISIT_CONTENT_URI"
...
.method public getPreferredWebsForTimeRange(J)Lcom/samsung/android/rubin/sdk/common/result/ApiResult;
    .locals 16
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(J)",
    ...
    sget-object v2, Lbi/H;->c:Landroid/net/Uri;
...
.method public getPreferredWebsForTpoContext(Lcom/samsung/android/rubin/sdk/common/TpoContext;)Lcom/samsung/android/rubin/sdk/common/result/ApiResult;
    .locals 16
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    sget-object v3, Lbi/H;->d:Landroid/net/Uri;
...
.method public getUris()Ljava/util/List;
    ...
    iget-object p0, p0, Lcom/samsung/android/rubin/sdk/module/inferenceengine/preferred/webs/V15PreferredWebsModule;->uris:Ljava/util/List;
...
.method public registerListener(Lkotlin/jvm/functions/Function0;)Lcom/samsung/android/rubin/sdk/common/result/ApiResult;
    ...
    const-string v0, "com.samsung.android.rubin.persona.preferredwebs"
    ...
    invoke-direct {p0}, Lcom/samsung/android/rubin/sdk/module/inferenceengine/preferred/webs/V15PreferredWebsModule;->getCtx()Lkotlin/jvm/functions/Function0;
