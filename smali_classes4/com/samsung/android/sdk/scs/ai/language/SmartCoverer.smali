...
.method public smartCover(Lcom/samsung/android/sdk/scs/ai/language/AppInfo;Ljava/lang/String;)Lcom/samsung/android/sdk/scs/base/tasks/Task;
    ...
    .line 2
    new-instance v0, Lcom/samsung/android/sdk/scs/ai/language/service/SmartCoverRunnable;

    iget-object v1, p0, Lcom/samsung/android/sdk/scs/ai/language/SmartCoverer;->mServiceExecutor:Lcom/samsung/android/sdk/scs/ai/language/service/SmartCoverServiceExecutor;

    invoke-direct {v0, v1}, Lcom/samsung/android/sdk/scs/ai/language/service/SmartCoverRunnable;-><init>(Lcom/samsung/android/sdk/scs/ai/language/service/SmartCoverServiceExecutor;)V

    .line 3
    invoke-virtual {v0, p1}, Lcom/samsung/android/sdk/scs/ai/language/service/SmartCoverRunnable;->setAppInfo(Lcom/samsung/android/sdk/scs/ai/language/AppInfo;)V

    .line 4
    invoke-virtual {v0, p2}, Lcom/samsung/android/sdk/scs/ai/language/service/SmartCoverRunnable;->setInputText(Ljava/lang/String;)V
...
.method public smartCover(Lcom/samsung/android/sdk/scs/ai/language/AppInfo;Ljava/lang/String;Ljava/util/Map;)Lcom/samsung/android/sdk/scs/base/tasks/Task;
    ...
    .line 7
    new-instance v0, Lcom/samsung/android/sdk/scs/ai/language/service/SmartCoverRunnable2;
    ...
    :goto_0
    invoke-direct {v0, v1, v2}, Lcom/samsung/android/sdk/scs/ai/language/service/SmartCoverRunnable2;-><init>(Lcom/samsung/android/sdk/scs/ai/language/service/SmartCoverServiceExecutor;Lcom/samsung/android/sdk/scs/base/tasks/TaskCompletionSource;)V
    ...
    const-string v2, "SmartCoverer"

    invoke-static {v2, v1}, Lcom/samsung/android/sdk/scs/base/utils/Log;->i(Ljava/lang/String;Ljava/lang/String;)V

    .line 10
    invoke-virtual {v0, p1}, Lcom/samsung/android/sdk/scs/ai/language/service/SmartCoverRunnable2;->setAppInfo(Lcom/samsung/android/sdk/scs/ai/language/AppInfo;)V

    .line 11
    invoke-virtual {v0, p2}, Lcom/samsung/android/sdk/scs/ai/language/service/SmartCoverRunnable2;->setInputText(Ljava/lang/String;)V

    .line 12
    invoke-virtual {v0, p3}, Lcom/samsung/android/sdk/scs/ai/language/service/SmartCoverRunnable2;->setExtraPrompt(Ljava/util/Map;)V
...
.method public smartCover(Ljava/lang/String;)Lcom/samsung/android/sdk/scs/base/tasks/Task;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    invoke-virtual {p0, v0, p1}, Lcom/samsung/android/sdk/scs/ai/language/SmartCoverer;->smartCover(Lcom/samsung/android/sdk/scs/ai/language/AppInfo;Ljava/lang/String;)Lcom/samsung/android/sdk/scs/base/tasks/Task;
...
.method public smartCoverWithSafety(Lcom/samsung/android/sdk/scs/ai/language/AppInfo;Ljava/lang/String;)Lcom/samsung/android/sdk/scs/base/tasks/Task;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
