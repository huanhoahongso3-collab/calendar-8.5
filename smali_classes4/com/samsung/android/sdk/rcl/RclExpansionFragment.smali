...
.method public static synthetic access$000(Lcom/samsung/android/sdk/rcl/RclExpansionFragment;)Z
    .locals 0

    iget-boolean p0, p0, Lcom/samsung/android/sdk/rcl/RclExpansionFragment;->mExpansionEnabled:Z

    return p0
.end method

.method public static synthetic access$100(Lcom/samsung/android/sdk/rcl/RclExpansionFragment;)Lcom/samsung/android/sdk/rcl/RclExpansionHelper;
    .locals 0

    iget-object p0, p0, Lcom/samsung/android/sdk/rcl/RclExpansionFragment;->mExpansionHelper:Lcom/samsung/android/sdk/rcl/RclExpansionHelper;
...
.method public disableExpansion()V
    ...
    invoke-virtual {p0}, Lcom/samsung/android/sdk/rcl/RclExpansionHelper;->disable()V
...
.method public enableExpansion(III)V
    ...
    const-string p2, ") must implement OnExpansionStatusListener."
    ...
    const-string v0, "Either Activity("
    ...
    const-string v0, ") or ParentFragment("
    ...
    const-string p1, "minHeight can not be bigger than maxHeight"
    ...
    .line 10
    iget-object p1, p0, Lcom/samsung/android/sdk/rcl/RclExpansionFragment;->mExpansionHelper:Lcom/samsung/android/sdk/rcl/RclExpansionHelper;

    invoke-virtual {p1, p0}, Lcom/samsung/android/sdk/rcl/RclExpansionHelper;->setExpansionStatusListener(Lcom/samsung/android/sdk/rcl/RclExpansionHelper$OnExpansionStatusListener;)V
    ...
    invoke-virtual {p1, p0}, Lcom/samsung/android/sdk/rcl/RclExpansionHelper;->setActivity(Landroid/app/Activity;)V
    ...
    const-string p1, "Do not allow negative numbers as height parameters"
...
.method public enableFlickToClose(Z)V
    ...
    invoke-virtual {p0, p1}, Lcom/samsung/android/sdk/rcl/RclExpansionHelper;->enableFlingToClose(Z)V
...
.method public final getExpansionHelper()Lcom/samsung/android/sdk/rcl/RclExpansionHelper;
    .locals 0
...
.method public isExpanded()Z
    ...
    iget-boolean p0, p0, Lcom/samsung/android/sdk/rcl/RclExpansionFragment;->mIsExpanded:Z
...
.method public isLocked()Z
    ...
    invoke-virtual {p0}, Lcom/samsung/android/sdk/rcl/RclExpansionHelper;->isLocked()Z
...
.method public lock()V
    ...
    invoke-virtual {p0}, Lcom/samsung/android/sdk/rcl/RclExpansionHelper;->lock()V
...
.method public onActivityCreated(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p1, v0}, Lcom/samsung/android/sdk/rcl/RclExpansionHelper;->setActivity(Landroid/app/Activity;)V

    invoke-virtual {p0}, Landroid/app/Fragment;->getParentFragment()Landroid/app/Fragment;

    move-result-object p1

    instance-of p1, p1, Lcom/samsung/android/sdk/rcl/RclExpansionFragment$OnExpansionStatusListener;
    ...
    check-cast p1, Lcom/samsung/android/sdk/rcl/RclExpansionFragment$OnExpansionStatusListener;

    iput-object p1, p0, Lcom/samsung/android/sdk/rcl/RclExpansionFragment;->mExpansionStatusListener:Lcom/samsung/android/sdk/rcl/RclExpansionFragment$OnExpansionStatusListener;
    ...
    :cond_2
    :goto_0
    iget-boolean p1, p0, Lcom/samsung/android/sdk/rcl/RclExpansionFragment;->mExpansionEnabled:Z

    if-eqz p1, :cond_4

    iget-object p1, p0, Lcom/samsung/android/sdk/rcl/RclExpansionFragment;->mExpansionStatusListener:Lcom/samsung/android/sdk/rcl/RclExpansionFragment$OnExpansionStatusListener;
    ...
    const-string v0, ") must implement OnExpansionStatusListener."
...
.method public final onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    new-instance v0, Lcom/samsung/android/sdk/rcl/RclExpansionFragment$1;

    invoke-virtual {p0}, Landroid/app/Fragment;->getActivity()Landroid/app/Activity;

    move-result-object v1

    invoke-direct {v0, p0, v1}, Lcom/samsung/android/sdk/rcl/RclExpansionFragment$1;-><init>(Lcom/samsung/android/sdk/rcl/RclExpansionFragment;Landroid/content/Context;)V
    ...
    invoke-virtual {p0, p1}, Lcom/samsung/android/sdk/rcl/RclExpansionHelper;->setRootView(Landroid/view/View;)V
...
.method public onExpansionClose()V
    .locals 0
...
.method public onExpansionMaxHeightChanged(I)V
    .locals 0
...
.method public onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, p1}, Lcom/samsung/android/sdk/rcl/RclExpansionHelper;->onSaveInstanceState(Landroid/os/Bundle;)V
...
.method public setExpansion(Z)Z
    ...
    invoke-virtual {p0, p1}, Lcom/samsung/android/sdk/rcl/RclExpansionHelper;->setExpansion(Z)Z
...
.method public setExpansionInternal(Z)Z
    .locals 1
    ...
    invoke-virtual {p0, p1}, Lcom/samsung/android/sdk/rcl/RclExpansionHelper;->requestExpansion(Z)V
...
.method public setExpansionMode(I)V
    ...
    const-string v0, "Invalid expansion mode "
    ...
    invoke-virtual {p0, p1}, Lcom/samsung/android/sdk/rcl/RclExpansionHelper;->setExpansionMode(I)V
    ...
    const-string p1, "Expansion is disabled."
...
.method public setFixedHeight(I)V
    ...
    invoke-virtual {p0, p1}, Lcom/samsung/android/sdk/rcl/RclExpansionHelper;->setFixedHeight(I)V
