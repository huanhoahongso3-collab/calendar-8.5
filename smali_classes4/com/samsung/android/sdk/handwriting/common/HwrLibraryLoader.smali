...
.method public static declared-synchronized loadLibrary(Ljava/lang/String;)Z
    ...
    const-string v0, "cannot load library "

    const-string v1, "/data/data/"

    const-string v2, "library loading package = "

    const-string v3, "spen package name = "

    const-class v4, Lcom/samsung/android/sdk/handwriting/common/HwrLibraryLoader;
    ...
    :try_start_0
    const-class v6, Lcom/samsung/android/sdk/pen/Spen;

    sget-object v7, Lcom/samsung/android/sdk/pen/Spen;->Companion:Lcom/samsung/android/sdk/pen/Spen$Companion;
    :try_end_0
    .catch Ljava/lang/ClassNotFoundException; {:try_start_0 .. :try_end_0} :catch_7
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    :try_start_1
    const-string v7, "SPEN_NATIVE_PACKAGE_NAME"
    ...
    :try_start_3
    const-string v9, "getSpenPackageName"
    ...
    :try_start_5
    sget-object v8, Lcom/samsung/android/sdk/handwriting/common/HwrLibraryLoader;->TAG:Ljava/lang/String;
    ...
    const-string v1, "library loading success from spen sdk"
    ...
    const-string v1, "Cannot find preloaded library!!!"
    ...
    const-string v1, "Cannot find getPackageName method!!!"
    ...
    const-string v1, "Cannot find preload mode checker!!!"
    ...
    const-string v1, "Cannot find spen sdk!!!"
...
.method private static declared-synchronized loadWorkaroundLibrary(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    const-class v1, Lcom/samsung/android/sdk/handwriting/common/HwrLibraryLoader;
